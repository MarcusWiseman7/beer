<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 0H0V24H24V0Z" fill="white" fill-opacity="0.01" stroke="none" />
    <path
    ...
    <path
        ...
        stroke-linejoin="round"
    />
    <path d="M16.6109 16.6108L20.8535 20.8535" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
</svg>
